<?php
$m = $message ?? [];
$formAction = $isEdit ? base_url('admin/transition-messages/' . $m['id']) : base_url('admin/transition-messages');
?>

<h1 class="h4 mb-3"><?= $isEdit ? 'Mesajı Düzenle' : 'Yeni Geçiş Mesajı' ?></h1>
